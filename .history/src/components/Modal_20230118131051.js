...
const Modal = ({product, addToCart, count}) => {
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
            ...
            <div
                ...
                >
                  <button
                    ...
                    onClick={() => setQuantity(count > 1 ? count - 1 : 1 )}>
                    -
                  </button>
        ...
        <div class="modal-footer  d-flex  justify-content-center ">
          ...
          <button type="button" class="btn btn-primary" onClick={()=> addToCart(productquantity)}>Add to cart</button>
        </div>
      </div>
    </div>
  </div>
